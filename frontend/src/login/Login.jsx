    ...
    return (
        <div className='flex flex-col items-center justify-center mix-w-full mx-auto'>
          ...
          bg-gray-400 bg-clip-padding
           backderop-filter backdrop-blur-lg bg-opacity-1'>
                <h1 className='text-3xl font-bold text-center text-gray-900'>Login
                    <span className='text-gray-950'> Chats </span>
                    </h1>
                    <form onSubmit={handelSubmit} className='flex flex-col text-white'>
                        <div>
                            <label className='label p-2' >
                                <span className='font-bold text-gray-950 text-xl label-text'>Email Id :</span>
                            </label>
                            <input
                                id='email'
                                type='email'
